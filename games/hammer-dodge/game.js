...
(() => {
    ...
    function update(deltaTime) {
        ...
        hammerSpeed = 3 + difficulty * 0.5;
        hammerSpawnInterval = Math.max(0.4, 1.5 - difficulty * 0.1);
    ...
    function draw() {
        ...
        if (gameState === 'ready') {
            ...
            ctx.fillText('🔨 망치 피하기', WIDTH / 2, HEIGHT / 2 - 40);
            
            ctx.font = '16px sans-serif';
            ctx.fillText('좌우 화살표 or A/D로 이동', WIDTH / 2, HEIGHT / 2);
            ctx.fillText('모바일: 터치로 이동', WIDTH / 2, HEIGHT / 2 + 30);
            ctx.fillText('탭해서 시작!', WIDTH / 2, HEIGHT / 2 + 70);
        }
    }
